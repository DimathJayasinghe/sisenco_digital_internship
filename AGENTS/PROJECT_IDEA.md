...
5. Uses the **AI Chat Assistant** to ask natural language questions (e.g., _"What were the common blockers last week?"_).
...
- **Fixed Fields (no user customization):**
  ...
  6.  Hours worked _(optional)_
  7.  Notes or links _(optional)_
...
- Examples: _Client A, Internal Tooling, R&D, Marketing_.
