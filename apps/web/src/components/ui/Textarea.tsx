  ...
  return (
    <div>
      ...
      <textarea
        ...
        className={cn(
          'min-h-32 w-full rounded-none border-2 border-zinc-900 bg-zinc-100 px-3 py-2 text-sm text-zinc-900 placeholder:text-zinc-400 dark:border-zinc-300 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder:text-zinc-500',
