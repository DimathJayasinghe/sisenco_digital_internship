  ...
  return (
    <div>
      ...
      <input
        ...
        className={cn(
          'w-full rounded-none border-2 border-zinc-900 bg-zinc-100 px-3 py-2 text-sm text-zinc-900 placeholder:text-zinc-400 dark:border-zinc-100 dark:bg-zinc-950 dark:text-zinc-100 dark:placeholder:text-zinc-500',
